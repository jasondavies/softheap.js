...
function SoftHeap(compare) {
  ...
  this.insert = function(e) {
    ...
    if (this.first === null) {
      ...
      while (t1.next !== null && t1.root.rank === t1.next.root.rank) {
        t2 = t1.next;
      ...
      if (t1.root.rank > this.rank) {
        this.rank = t1.root.rank;
      }
      this.updateSuffixMin(t1);
      this.size++;
    }
    return true;
  };
...
SoftHeap.prototype.removeTree = function(t) {
  if (t.prev !== null) {
    t.prev.next = t.next;
  } else {
    this.first = t.next;
...
SoftHeap.prototype.updateSuffixMin = function(t) {
  for (; t !== null; t = t.prev) {
    t.updateSuffixMin();
  }
};

SoftHeap.prototype.extractMin = function() {
  if (this.first === null) {
    throw {"error": "empty!"};
  }
...
SoftHeap.prototype.findMin = function() {
  if (this.first === null) {
    throw {"error": "empty!"};
  }
  return this.first.getSuffixMin().root.list.head.e;
};

export {SoftHeap};
export default SoftHeap;
